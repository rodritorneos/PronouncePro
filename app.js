...
const API_URL = "https://defeat-coordinates-asks-accompanied.trycloudflare.com"; // Cambia si tu backend usa otro puerto
...
// --- Actualizar username docente (solo localStorage) ---
function actualizarUsernameDocente(newUsername) {
  localStorage.setItem("docente_username", newUsername);
  return Promise.resolve({ username: newUsername, message: "Actualizado localmente" });
}
